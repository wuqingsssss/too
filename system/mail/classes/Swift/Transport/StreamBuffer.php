  ...
  implements Swift_Transport_IoBuffer
{
  ...
  private function _establishSocketConnection()
  {
    ...
    {
    	$error_message='Connection could not be established with host ' . $this->_params['host'] .
        ' [' . $errstr . ' #' . $errno . ']';
    	
    	$log_sys=getRegistry()->get('log_sys');
    	$log_sys->info($error_message);
    	
      	//throw new Swift_TransportException($error_message);
    }
