...
class Mobile_Detect
{
    ...
    public function is_caijun_browser(){
    ...
    public function get_platform(){
    	//$this->log_payment->info('is_app::session:'.serialize($_SESSION['platform']));
    
    	if (isset($_SESSION['platform'])&&$_SESSION ['platform']) {
    ...
    public function is_app(){
    	...
    	if (isset($_SESSION['platform']['platform_code'])&&$_SESSION ['platform']['platform_code']=='app' ) {
    		return true;
    	} else {
    		return false;
    	}
    }
    public function is_andorid_app($versioncode=''){
    
    	//$this->log_payment->info('is_andorid_app::session:'.serialize($_SESSION['platform']));
    	if (isset($_SESSION['platform']['platform'])&&$_SESSION ['platform']['platform']=='Android' ) {
    		if(!empty($versioncode)) return isset($_SESSION ['platform']['versionCode'])&&(!empty($_SESSION ['platform']['versionCode']))&&(int)($_SESSION ['platform']['versionCode']>=(int)$versioncode);
    		else
    		return true;
    ...
    public function is_ios_app(){
    	if (isset($_SESSION['platform']['platform'])&&$_SESSION['platform']['platform']=='IOS' ) {
    		return true;
    	} else {
    		return false;
    	}
    ...
    {   
    	...
    	foreach($rules as $key=>$val){
    		...
    		{
    		$browser=$key;
    		return $browser.'['.$this->getUserAgent().']';
    		}
    	}
