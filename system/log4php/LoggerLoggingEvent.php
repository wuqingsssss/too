...
class LoggerLoggingEvent {
	...
	*/
	...
	public static function getStartTime() {
		...
		if(!isset(self::$costTime)) {
			self::$costTime = microtime(true);
		}
	...
	public function getCTime() {
		...
		$c=LoggerLoggingEvent::getCostTime();
		
		
		$costtime=$this->timeStamp - $c;
		
	
	return number_format($costtime * 1000, 1, '.', '');
	}
	/**
	...
	public function getTime() {
		...
		return number_format(($eventTime - $eventStartTime) * 1000, 1, '.', '');
	}
